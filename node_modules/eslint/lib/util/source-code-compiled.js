...
SourceCode.prototype = {
    ...
    getText: function getText(node, beforeCount, afterCount) {
        if (node) {
            return this.text !== null ? this.text.slice(Math.max(node.range[0] - (beforeCount || 0), 0), node.range[1] + (afterCount || 0)) : null;
        } else {
            return this.text;
        }
    },
...
//# sourceMappingURL=source-code-compiled.js.map