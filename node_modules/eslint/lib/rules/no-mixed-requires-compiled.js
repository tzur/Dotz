...
module.exports = function (context) {
     ...
     */
    function getDeclarationType(_x) {
        var _again = true;

        _function: while (_again) {
            var initExpression = _x;
            _again = false;
     ...
     */
    function inferModuleType(_x2) {
        var _again2 = true;

        _function2: while (_again2) {
            var initExpression = _x2;
            _again2 = false;

            if (initExpression.type === "MemberExpression") {
                // "var x = require('glob').Glob;"
                _x2 = initExpression.object;
                _again2 = true;
                continue _function2;
...
//# sourceMappingURL=no-mixed-requires-compiled.js.map