...
module.exports = function (context) {
    ...
    var SUPPORTED_EXPRESSIONS = {
        "MemberExpression": function MemberExpression(parent) {
            return !parent.computed && (
            // regular property assignment
            parent.parent.left === parent ||
            // or the last identifier in an ObjectPattern destructuring
            parent.parent.type === "Property" && properties && parent.parent.value === parent && parent.parent.parent.type === "ObjectPattern" && parent.parent.parent.parent.left === parent.parent.parent);
        },
...
//# sourceMappingURL=id-length-compiled.js.map