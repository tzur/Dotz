    ...
    return {
        ...
        "ExpressionStatement": function ExpressionStatement(node) {
            ...
            if (hasExcessParens(node.expression)) {
                ...
                firstToken.value !== "function" || node.expression.type === "FunctionExpression") && (
                // For such as `(class{}.foo.bar)`
                firstToken.value !== "class" || node.expression.type === "ClassExpression")) {
        ...
        "MemberExpression": function MemberExpression(node) {
            if (hasExcessParens(node.object) && precedence(node.object) >= precedence(node) && (node.computed || !(node.object.type === "Literal" && typeof node.object.value === "number" && /^[0-9]+$/.test(context.getFirstToken(node.object).value) ||
...
//# sourceMappingURL=no-extra-parens-compiled.js.map