...
function isBlockBindingsInLoop(loopNode, reference) {
    ...
    return(
        ...
        declaration && declaration.type === "VariableDeclaration" && (declaration.kind === "let" || declaration.kind === "const") &&
        // Checks whether this is in the loop.
        declaration.range[0] > loopNode.range[0] && declaration.range[1] < loopNode.range[1]
    );
}
...
//# sourceMappingURL=no-loop-func-compiled.js.map