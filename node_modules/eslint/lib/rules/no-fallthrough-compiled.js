...
module.exports = function (context) {
    ...
    return {
        ...
        "SwitchCase": function SwitchCase(node) {
            ...
            if (!switchData.lastCaseClosed) {
                ...
                if (!comment || !FALLTHROUGH_COMMENT.test(comment.value)) {
                    ...
                    context.report(switchData.lastCase, "Expected a \"break\" statement before \"{{code}}\".", { code: node.test ? "case" : "default" });
                }
            }
        ...
        "SwitchStatement:exit": function SwitchStatementExit() {
            switches.pop();
        }
    };
};
...
//# sourceMappingURL=no-fallthrough-compiled.js.map