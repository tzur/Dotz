...
module.exports = function (context) {
    ...
    function validateNode(node, leftSide) {
        ...
        if (astUtils.isTokenOnSameLine(leftToken, operatorToken) && astUtils.isTokenOnSameLine(operatorToken, rightToken)) {
            ...
            return;
        } else if (!astUtils.isTokenOnSameLine(leftToken, operatorToken) && !astUtils.isTokenOnSameLine(operatorToken, rightToken)) {
...
//# sourceMappingURL=operator-linebreak-compiled.js.map