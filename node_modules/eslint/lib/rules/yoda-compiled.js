    ...
    _function: while (_again) {
        ...
        switch (a.type) {
            ...
            case "MemberExpression":
                ...
                if (!(_left = same(a.object, b.object))) {
                    return _left;
                }
...
module.exports = function (context) {
    ...
    function isRangeTest(node) {
        ...
        function isParenWrapped() {
            ...
            return (tokenBefore = context.getTokenBefore(node)) && tokenBefore.value === "(" && (tokenAfter = context.getTokenAfter(node)) && tokenAfter.value === ")";
        }
...
//# sourceMappingURL=yoda-compiled.js.map