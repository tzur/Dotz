...
function isES5Constructor(node) {
    return node.id && node.id.name[0] === node.id.name[0].toLocaleUpperCase();
}
        ...
        while (node) {
            ...
            switch (parent.type) {
                ...
                case "AssignmentExpression":
                    return parent.right === node && parent.left.type === "MemberExpression";
                ...
                case "MemberExpression":
                    return parent.object === node && parent.property.type === "Identifier" && bindOrCallOrApplyPattern.test(parent.property.name) && isCallee(parent) && parent.parent.arguments.length > 0 && !astUtils.isNullOrUndefined(parent.parent.arguments[0]);
                ...
                case "CallExpression":
                    if (isReflectApply(parent.callee)) {
                        return parent.arguments.length === 3 && parent.arguments[0] === node && !astUtils.isNullOrUndefined(parent.arguments[1]);
                    }
                    if (isArrayFrom(parent.callee)) {
                        return parent.arguments.length === 3 && parent.arguments[1] === node && !astUtils.isNullOrUndefined(parent.arguments[2]);
                    }
                    if (isMethodWhichHasThisArg(parent.callee)) {
                        return parent.arguments.length === 2 && parent.arguments[0] === node && !astUtils.isNullOrUndefined(parent.arguments[1]);
                    }
                    return false;
    ...
    return {
        ...
        "Program": function Program(node) {
            ...
            stack.push({
                init: true,
                node: node,
                valid: !(scope.isStrict || features.modules || features.globalReturn && scope.childScopes[0].isStrict)
            });
        },
...
//# sourceMappingURL=no-invalid-this-compiled.js.map