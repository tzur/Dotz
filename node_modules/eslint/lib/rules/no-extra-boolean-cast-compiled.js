            ...
            if (grandparent.type === "IfStatement") {
                ...
                // do ... while (<bool>)
                    ...
                    // while (<bool>) ...
                        ...
                        // <bool> ? ... : ...
                    } else if (grandparent.type === "ConditionalExpression" && parent === grandparent.test) {
                            context.report(node, "Redundant double negation in a ternary condition.");

                            // for (...; <bool>; ...) ...
                        } else if (grandparent.type === "ForStatement" && parent === grandparent.test) {
                                context.report(node, "Redundant double negation in a for loop condition.");

                                // !<bool>
                            } else if (grandparent.type === "UnaryExpression" && grandparent.operator === "!") {
                                    context.report(node, "Redundant multiple negation.");

                                    // Boolean(<bool>)
                                } else if (grandparent.type === "CallExpression" && grandparent.callee.type === "Identifier" && grandparent.callee.name === "Boolean") {
                                        context.report(node, "Redundant double negation in call to Boolean().");

                                        // new Boolean(<bool>)
                                    } else if (grandparent.type === "NewExpression" && grandparent.callee.type === "Identifier" && grandparent.callee.name === "Boolean") {
...
//# sourceMappingURL=no-extra-boolean-cast-compiled.js.map