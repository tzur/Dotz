...
function isTrailingCommaAllowed(node, lastItem) {
    switch (node.type) {
        case "ArrayPattern":
            ...
            return lastItem.type !== "RestElement" && lastItem.type !== "SpreadElement";

        // TODO(t-nagashima): Remove this case after https://github.com/eslint/espree/issues/195 was fixed.
        case "ArrayExpression":
            return node.parent.type !== "ForOfStatement" || node.parent.left !== node || lastItem.type !== "SpreadElement";
...
module.exports = function (context) {
    ...
    function forbidTrailingComma(node) {
        ...
        if (trailingToken.value === ",") {
            context.report(lastItem, trailingToken.loc.start, UNEXPECTED_MESSAGE);
        }
    }
...
//# sourceMappingURL=comma-dangle-compiled.js.map