...
module.exports = function (context) {
    ...
    var options = context.options[0] || {},
        ...
        beforeColon = +!!options.beforeColon,
        // Defaults to false
    ...
    function report(property, side, whitespace, expected) {
        ...
        if ((diff && mode === "strict" || diff < 0 && mode === "minimum") && !(expected && containsLineTerminator(whitespace))) {
    ...
    function getPropertyWhitespace(property) {
        var whitespace = /(\s*):(\s*)/.exec(context.getSource().slice(property.key.range[1], property.value.range[0]));
...
//# sourceMappingURL=key-spacing-compiled.js.map