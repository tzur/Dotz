...
module.exports = function (context) {
    ...
    function isContainedInScopeVars(variable, scopeVars) {
        return scopeVars.some(function (scopeVar) {
            return (scopeVar.identifiers.length > 0 || options.builtinGlobals && "writeable" in scopeVar) && variable.name === scopeVar.name && !isDuplicatedClassNameVariable(scopeVar) && !isOnInitializer(variable, scopeVar) && !(options.hoist !== "all" && isInTdz(variable, scopeVar));
        });
    }
    ...
    function checkShadowsInScope(variables, scope) {
        ...
        variables.forEach(function (variable) {
            ...
            if (variable.identifiers.length > 0 && isContainedInScopeVars(variable, scope.variables)) {
                context.report(variable.identifiers[0], "{{name}} is already declared in the upper scope.", { name: variable.name });
            } else {
...
//# sourceMappingURL=no-shadow-compiled.js.map