...
module.exports = function (context) {
    ...
    function checkThroughReference(builtins, reference, index, references) {
        ...
        if (identifier && builtins[identifier.name] && exceptions.indexOf(identifier.name) === -1 && reference.init === false && reference.isWrite() && (
        // Destructuring assignments can have multiple default value,
        // so possibly there are multiple writeable references for the same identifier.
        index === 0 || references[index - 1].identifier !== identifier)) {
            context.report(identifier, "{{name}} is a read-only native object.", { name: identifier.name });
        }
    }
...
//# sourceMappingURL=no-native-reassign-compiled.js.map