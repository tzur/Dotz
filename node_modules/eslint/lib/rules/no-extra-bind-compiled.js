...
module.exports = function (context) {
    ...
    return {
        "CallExpression": function CallExpression(node) {
            if (node.arguments.length === 1 && node.callee.type === "MemberExpression" && node.callee.property.name === "bind" && /FunctionExpression$/.test(node.callee.object.type)) {
                scope.push({
                    call: node,
                    depth: -1,
                    found: 0
...
//# sourceMappingURL=no-extra-bind-compiled.js.map