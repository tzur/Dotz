          ...
          if(Meteor.isServer){
            ...
            Meteor.call('updateUserPeopleLikedMyConnection', likeSmartRef, function(error){
              if(error) {
                ...
                Meteor.call('updateUserPeopleLikedMyConnectionCounter', likeSmartRef.dot.ownerUserId)
              }
            });
            ...
            Meteor.call('updateUserPeopleLikedMyDotz', likeSmartRef, function(error) {
              if (error) {
                ...
                Meteor.call('updateUserPeopleLikedMyDotzCounter', likeSmartRef.connection.connectedByUserId)
              }
            });
          }
        })
