...
///discover-your-way:
publicRoutes.route( '/discover-your-way', {
  name: 'guideLanding',
  action() {
    BlazeLayout.render( 'guideLanding' );
  }
});

///start-discover - guideLanding
publicRoutes.route( '/discover-how-to-start', {
  name: 'guideLanding',
  action() {
    BlazeLayout.render( 'guideLanding' );
  }
...
//TODO: for the old links (TLV global :/ )
...
//The new dot slug (with "/:dotId") :
publicRoutes.route( '/dot/:userId/:dotId/:dotSlug', {
  name: 'dot-show',
  action() {
    BlazeLayout.render( 'default', { yield: 'dotShow' } );
  }
