...
Meteor.methods({
  createDot(doc, redirectAfterCreate){
    ...
    //if (personalDescription || (personalDescription === "") ) {
    //  check(personalDescription, String);
    //  //console.log("personalDescription IF >>>> " + personalDescription)
    //} else {
    //  check(personalDescription, undefined);
    //  //console.log("personalDescription ELSE >>>> " + personalDescription)
    //}
