...
//NOTE: this is the smartRef schema!!!
Schema.dotSuperTag = new SimpleSchema({
  ...
  _id: {
    type: String,
    autoValue: function() {
      let parentTag = this.field("parentTag");
      if (parentTag.isSet) {
        return parentTag.replace(/ /g,'');
      }
      //else {
      //  this.unset();
      //}
    ...
    //autoValue: function() {
    //  let dotType = this.field("parentTag");
    //  //return dotType();
    //  if (dotType.isSet) {
    //    return true;
    //  } else {
...
Schema.dotSchema = new SimpleSchema({
  ...
  //The Dot's superTags system:
  selfSuperTags: {
    type: [Schema.dotSuperTag],
    defaultValue: [], //TBD
    optional: true
  },
  superTagsToFilterConnectedDotz: {
    type: [Schema.dotSuperTag],
    defaultValue: [], //TBD
    optional: true
  },
