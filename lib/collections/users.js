...
let userProfile = new SimpleSchema({
  ...
  userType: {
    ...
    optional: true,
    defaultValue: ["Tech"],
    allowedValues: ['User', 'Hotel', 'Tech', 'Guide', 'ContentMaker', 'Tourism'],
    label: "userType"
  },
  userCommunities: {
    type: [String],
    optional: true,
    defaultValue: ["Startup_IL"],
    allowedValues: ['Startup_IL', 'Tel_Aviv'],
    label: "userType"
  },
  userSearchType: {
    type: String,
  ...
  //  defaultValue: []
  //},
  //an Array for the last "9 dotz" (which connected by the user):
  lastDotzUserConnectedTo:{
    type:[String], //dotIDs
    optional: true,
    defaultValue: []
  },
...
//TBD:
//ERROR from insertusernameMongoError:
// E11000 duplicate key error index: dotzBeta2.users.$username_1 dup key: { : "Omri Moran" }
