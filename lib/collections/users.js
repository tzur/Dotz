...
let userProfile = new SimpleSchema({
  ...
  userConnectivityDocId: {
    type: String,
    optional: true
  },

  userConnectionsCounter: {
    type: Object,
    optional: true
  },
  "userConnectionsCounter.peopleLikedMyDotz": {
    type: Number,
    defaultValue: 0,
    optional: true
  },
  "userConnectionsCounter.peopleConnectedMyDotz": {
    type: Number,
    defaultValue: 0,
    optional: true
  },
  "userConnectionsCounter.peopleLikedMyConnections": {
    type: Number,
    defaultValue: 0,
    optional: true
  },
