...
Meteor.publish('createdByUserListsForAutoGenerate', function (userName) {
  check(userName, String);                                             // 103
  var currentUser = Meteor.users.findOne({ username: userName });      // 104
  var createByUserLists = currentUser.profile.createdByUserLists;      // 105
  createByUserLists.push(currentUser.profile.profileDotId);            // 106
  return Dotz.find({ _id: { $in: createByUserLists } });               // 107
});                                                                    //
/////////////////////////////////////////////////////////////////////////
